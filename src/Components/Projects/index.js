        ...
        <div className="project-container">
          ...
          <div className="project-flex">
            ...
            <ul className="project-list">
              ...
              <li>
                Authenticating by taking username, password and doing login post
                HTTP API Call.
              </li>
              <li>
                Persisted user login state by keeping jwt token in client
                storage, Sending it in headers of further API calls to authorize
                the user.
              </li>
              <li>
          ...
          <div className="project-flex">
            ...
            <ul className="project-list">
              <li>
                ...
                posts, users can also search posts with post captions, users can
                be able to like and dislike the post and also view the user
                specific posts.
              </li>
              <li>
                Implemented different routes for features like login, home, user
                profile, profile by using React Router components Route, Switch,
                Link.
              </li>
              <li>
              ...
              <li>
                Used fetch to call REST APIs for authentication, list of posts,
                user profile, and posts search APIs.
              </li>
              <li>
              ...
              <li>
                Implemented a protected route to ensure only authenticated users
                can access the pages like user profile, Home, etc.
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="project-flex">
            ...
            <ul className="project-list">
              <li>
                ...
                shelf, want to read shelf , and user can also search books with
                author's name and book's name.
              </li>
              <li>
              ...
              <li>
                Implemented stars (rating), dropdown (select) using React Third
                Party libraries called React Rating Stars, React Select.
              </li>
              <li>
                Used Figma mockups to implement UI-rich and pixel-perfect React
                components.
              ...
              <li>
                Implemented a protected route to ensure only authenticated users
                can access the pages like home, bookshelves, etc.
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="project-flex">
            ...
            <ul className="project-list">
              <li>
                ...
                Swiggy/Zomato where users can see popular restaurants with sort
                by rating, specific restaurant details, adding or removing food
                items to cart, and payments section.
              </li>
              <li>
                Implemented different routes for features like login, home,
              ...
              <li>
                Implemented a protected route to ensure only authenticated users
                can access the pages like home, specific restaurant details,
                etc.
              </li>
            </ul>
          </div>
